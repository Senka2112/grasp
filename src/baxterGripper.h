...
public:
    ...
    void reset();
    void go_to(float);
    void command(std::string, bool = false, ros::Duration = ros::Duration(0.0), std::string = "");
    void open();
    void close();
...
private:
    ...
    void _wait(ros::Duration = ros::Duration(3.0));                               //  waits until the gripper is no longer moving
};
